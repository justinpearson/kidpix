KiddoPaint.Tools.Toolbox.Stamp = function () {
  ...
  this.texture = function () {
    ...
    return KiddoPaint.Stamps.stamp(
      ...
      tool.size,
      hueShift,
      tool.useColor ? KiddoPaint.Current.color : null,
    );
  };
  ...
  this.mousedown = function (ev) {
    ...
    KiddoPaint.Display.context.fillStyle = tool.useColor
  ...
  this.mousemove = function (ev) {
    var rng = srng(tool.seed);
    if (!tool.isDown) {
      KiddoPaint.Display.previewContext.fillStyle = tool.useColor
        ? KiddoPaint.Current.color
        : null;
      var brushFill = tool.texture();
