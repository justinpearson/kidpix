KiddoPaint.Tools.Toolbox.Guilloche = function () {
  ...
  this.mousemove = function (ev) {
    ...
    if (
      ...
      distanceBetween(tool.previousEv, ev) > tool.minDistance
    ) {
      ...
      for (var i = 0; i < Math.PI * 4; i += 0.007) {
        var coord = guil(
          tool.randomSettings.outradius,
          tool.randomSettings.r,
          tool.randomSettings.m,
          i,
          tool.randomSettings.inradius,
          tool.randomSettings.Q,
          tool.randomSettings.m,
          tool.randomSettings.n,
        );
