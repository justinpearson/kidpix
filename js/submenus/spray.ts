KiddoPaint.Submenu.spray = [
  ...
  },
  {
    ...
    handler: function () {
      KiddoPaint.Tools.SpritePlacer.image = KiddoPaint.Textures.SprayPaint3(
        KiddoPaint.Current.color,
      );
      KiddoPaint.Current.tool = KiddoPaint.Tools.SpritePlacer;
    },
  },
  {
    ...
    handler: function () {
      KiddoPaint.Tools.SpritePlacer.image = KiddoPaint.Textures.SprayPaint4(
        KiddoPaint.Current.color,
      );
      KiddoPaint.Current.tool = KiddoPaint.Tools.SpritePlacer;
    },
  },
  {
    ...
    handler: function () {
      KiddoPaint.Tools.SpritePlacer.image = KiddoPaint.Textures.SprayPaint5(
        KiddoPaint.Current.color,
      );
      KiddoPaint.Current.tool = KiddoPaint.Tools.SpritePlacer;
    },
  },
  {
    ...
    handler: function () {
      KiddoPaint.Tools.SpritePlacer.image = KiddoPaint.Textures.SprayPaint6(
        KiddoPaint.Current.color,
      );
      KiddoPaint.Current.tool = KiddoPaint.Tools.SpritePlacer;
    },
  },
  {
    ...
    handler: function () {
      KiddoPaint.Tools.SpritePlacer.image = KiddoPaint.Textures.SprayPaint7(
        KiddoPaint.Current.color,
      );
      KiddoPaint.Current.tool = KiddoPaint.Tools.SpritePlacer;
    },
