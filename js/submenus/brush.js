    ...
    handler: function () {
      ...
      KiddoPaint.Tools.PlainBrush.texture = function () {
        ...
        return KiddoPaint.Current.modifiedMeta
          ? KiddoPaint.Brushes.RCircles()
          : KiddoPaint.Brushes.Circles(KiddoPaint.Current.color);
      };
    },
  },
  {
...
{
    name: 'Drippy Paint',
    imgSrc: './src/assets/img/tool-menu-wacky-brush-83.png',
    handler: function() {
        KiddoPaint.Display.canvas.classList = "";
        KiddoPaint.Display.canvas.classList.add('cursor-paint-brush');
...
{
    name: 'Alphabet Line',
    imgSrc: './src/assets/img/tool-menu-wacky-brush-85.png',
    handler: function() {
        KiddoPaint.Display.canvas.classList = "";
        KiddoPaint.Display.canvas.classList.add('cursor-paint-brush');
        KiddoPaint.Sounds.unimpl();
    ...
    handler: function () {
      ...
      KiddoPaint.Tools.PlainBrush.texture = function (step) {
        return KiddoPaint.Current.modifiedCtrl
          ...
          : KiddoPaint.Brushes.FollowingSine(
              KiddoPaint.Current.modifiedMeta
                ? KiddoPaint.Colors.nextColor()
                : KiddoPaint.Current.color,
              step,
...
{
    name: 'Caterpillars',
    imgSrc: './src/assets/img/tool-menu-wacky-brush-90.png',
    handler: function() {
        KiddoPaint.Display.canvas.classList = "";
        KiddoPaint.Display.canvas.classList.add('cursor-paint-brush');
        KiddoPaint.Sounds.unimpl();
...
*/
  {
    ...
    handler: function () {
      ...
      KiddoPaint.Tools.AnimBrush.texture = function () {
        KiddoPaint.Sounds.brushbubbly();
        return KiddoPaint.Current.modifiedMeta
          ? KiddoPaint.Brushes.Triangles()
          : KiddoPaint.Brushes.Splatters();
      };
    },
  },
  {
...
{
    name: 'Roll The Dice',
    imgSrc: './src/assets/img/tool-menu-wacky-brush-93.png',
    handler: function() {
        KiddoPaint.Display.canvas.classList = "";
        KiddoPaint.Display.canvas.classList.add('cursor-paint-brush');
        KiddoPaint.Sounds.unimpl();
